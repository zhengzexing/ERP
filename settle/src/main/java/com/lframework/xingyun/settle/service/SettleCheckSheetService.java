...
public interface SettleCheckSheetService extends BaseMpService<SettleCheckSheet> {
     ...
     * @return
     */
    PageResult<SettleCheckSheet> query(Integer pageIndex, Integer pageSize, QuerySettleCheckSheetVo vo);
     ...
     * @return
     */
    List<SettleCheckSheet> query(QuerySettleCheckSheetVo vo);
     ...
     * @return
     */
    List<SettleCheckSheet> getApprovedList(String supplierId, LocalDateTime startTime, LocalDateTime endTime);
